...
def weather_input():
	...
	if(refscenario in ['IPCC A1B', 'IPCC A2', 'IPCC B1']):
		...
		st.markdown(original_title, unsafe_allow_html=True)
		ipccyear = ste.radio("Select a reference future year", ipccyear_list, horizontal=True, key='ipcc') 
		refweatheryear = ipccyear

	elif(refscenario in ['NEN 5060:2018','NEN 5060:2018 (1% Extreme)', 'NEN 5060:2018 (5% Extreme)']):
		refweatheryear = 2018
