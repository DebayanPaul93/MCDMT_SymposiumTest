...
def weather_input():
	...
	original_title = '<p style="font-family:Sans serif; color:Red; font-size: 30px;"><b>Location of Archive</b></p>'
	...
	if(location == 'Netherlands'):
		...
		if(refscenario in scenario_list[2:]):
			original_title = '<p style="font-family:Sans serif; color:Red; font-size: 20px;"><b>IPCC Future Reference Year</b></p>'
			st.markdown(original_title, unsafe_allow_html=True)
